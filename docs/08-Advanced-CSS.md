...
2. [Tailwind CSS Full Course for Beginners | Complete All-in-One Tutorial | 3 Hours](https://youtu.be/lCxcTsOHrjo?si=mTFr_mYuWxc59ldu)
3. [Tailwind CSS Crash Course](https://youtu.be/UBOj6rqRUME?si=BZkghnqUU-a6eoW9)
4. [Should You Use Tailwind CSS?](https://youtu.be/hdGsFpZ0J2E?si=ZRR3V0-DnVVL8MUU)
5. [Tailwind Labs | Official Screencasts](https://www.youtube.com/c/TailwindLabs/videos)
6. [Tailwind CSS - Zero to Hero tailwind css - tailwind v3 2023](https://www.udemy.com/course/tailwind-css-zero-to-hero/)
7. [Tailwind CSS From Scratch | Learn By Building Projects](https://www.udemy.com/course/tailwind-from-scratch/)
8. [Advanced CSS and Sass: Flexbox, Grid, Animations and More!](https://www.udemy.com/course/advanced-css-and-sass/)

### 08.01.02 Radix UI

1. [Radix UI | Official Website](https://www.radix-ui.com)
2. [Radix UI | Official Documentation](https://www.radix-ui.com/primitives/docs/overview/introduction)
